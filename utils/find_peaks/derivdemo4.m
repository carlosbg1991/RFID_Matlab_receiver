...
% Plot the signal and smoothed derivatives in the four quadrants of the plot window
subplot(2,2,1)
plot(x,y)
subplot(2,2,2)
% SmoothWidth = 3
plot(x,fastsmooth(d,3,3)')
subplot(2,2,3)
% SmoothWidth = 10
plot(x,fastsmooth(d,10,3))
subplot(2,2,4)
% SmoothWidth = 20
plot(x,fastsmooth(d,20,3))
